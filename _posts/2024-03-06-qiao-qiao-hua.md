...
但是，如何才能让这些 AI 真正理解你的心声，成为你的知己呢？答案就是“Prompt”。Prompt 其实就是你给 AI 的指令。它可以是一句话，一段文字，也可以是一个代码片段。通过 Prompt，你可以告诉 AI 你想要它做什么。
...
走在与 AI 交流的道路上，我们难免会遇到一些小绊脚石。有时候，我们以为我们的指示清晰明了，却得到了一些让人摸不着头脑的回答。比如，如果你问 AI：“你能告诉我关于那个东西的信息吗？”AI 可能会回答：“对不起，我不确定你指的是哪个‘东西’。”这就是典型的太模糊的 Prompt。另一种情况是，我们可能给出了太多细节，让 AI 混淆了重点，就像是在说：“在下雨的星期二，我穿着蓝色衬衫去超市，突然想知道番茄的营养价值。”AI 可能会回答：“对不起，我不懂你的问题。”所以，找到合适的平衡，避免模糊和过度细化，是与 AI 愉快对话的关键。
...
与 AI 的交流就像是一场舞蹈，需要双方的默契和适时的引导。记得，AI 是你的舞伴，而不是对手。如果你发现 AI 没有按照你预期的方式回应，不妨尝试改变你的 Prompt，或者提供更多的背景信息。有时候，即使是轻微的调整，也能带来截然不同的结果。比如，如果你对 AI 提出的建议不满意，可以尝试说：“这个建议很有趣，但我想要一些更具创意的想法。”这样的迭代式对话，就像是在舞池中尝试不同的舞步，最终你们会找到那个完美的节奏。记住，与 AI 的交流是一个不断学习和适应的过程，享受这个过程，让你的 AI 交流更加流畅和高效。

### 番外篇：小窍门大汇总

我们已经一起跳过了不少舞步，现在是时候把这些小技巧收藏起来了。为了让你的 AI 对话旅程更加顺畅，这里有一份小窍门大汇总，让你随时查阅：

- 明确目标：在构建 prompt 之前，先清楚地知道你想从 AI 得到什么样的信息或帮助。
- 简洁有力：尽量使你的 prompt 简洁而不失信息量，避免不必要的废话。
- 具体详细：提供足够的上下文和细节，帮助 AI 更好地理解你的请求。
- 使用明确的指令：直接明了地表达你的需求，就像对待一个能理解你的朋友。
...
- [GitHub 上 100K+的项目-Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts)
